...
import { View, StyleSheet, ScrollView, SafeAreaView, Image, TouchableOpacity, Switch } from 'react-native';
      ...
      <ScrollView style={styles.container}>
        ...
        <SettingBlock title="预览">
          <View style={styles.previewContainer}>
            ...
            <View style={[styles.previewImageContainer, { backgroundColor: isDark ? '#000' : '#f2f2f7' }]}>
